...
//    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_edit_user) {
            Intent intent = new Intent(AssignedAndBiddedTasksViewActivity.this, EditUserActivity.class);
            ...
            Intent intent = new Intent(AssignedAndBiddedTasksViewActivity.this, ScanQRCodeActivity.class);
            startActivity(intent);
            ...
            if(getApplicationContext().deleteFile(USER_FILE_NAME)){
                ...
                Intent intent = new Intent(AssignedAndBiddedTasksViewActivity.this, LoginActivity.class);
                startActivity(intent);
                finish();
            }
        }
